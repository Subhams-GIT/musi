...
export default function SideBar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={` h-[70vh] w-full flex flex-col justify-center items-center gap-y-5 text-md transition-all duration-300`}
      >
        <button
          id="home"
        ...
        <button
          id="create"
          className={`flex justify-center items-center  ${open ? "w-[70%] px-8" : ""} ${selectedTab === "create" ? "bg-blue-500" : ""} ${open ? "bg-blue-600" : ""} gap-3 rounded-lg  py-2 mx-8 text-sm`}
        ...
        <button
          id="music"
          className={`flex justify-center items-center ${open ? "w-[70%] px-8" : ""} ${open ? "bg-blue-600" : ""} gap-3 rounded-lg  py-2 mx-8 text-sm`}
          onClick={() => handleTabClick("music", "join")}
        >
          <Music /> {open ? "Music" : ""}
        </button>
      </div>
